...
<TOOL_USAGE_RULES>
1. To query the database, use the 'query' tool.
2. The argument must be a valid JSON object with the key 'sql'.
3. DO NOT combine the tool name and JSON into one string like 'query{...}'. 
4. Call tools individually. Example: query(sql="SELECT...")
</TOOL_USAGE_RULES>
